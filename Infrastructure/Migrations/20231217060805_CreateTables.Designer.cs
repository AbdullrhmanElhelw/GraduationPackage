...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231217060805_CreateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.HospitalAdmin", b =>
                {
                    b.HasBaseType("Domain.Entites.ApplicationUser");
            ...
            modelBuilder.Entity("Domain.Entites.Relative", b =>
                {
                    b.HasBaseType("Domain.Entites.ApplicationUser");
            ...
            modelBuilder.Entity("Domain.Entites.HospitalAdmin", b =>
                {
                    b.HasOne("Domain.Entites.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entites.HospitalAdmin", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entites.Relative", b =>
                {
                    b.HasOne("Domain.Entites.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entites.Relative", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
